...
@section('content')
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title"> Cree Estudiantes </h3>
        </div>
        ...
        <form action="{{ route( 'estudiante.store' ) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="apellidos" id="apellidos" placeholder="Introduzca los apellidos">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="numero_telefono" id="numero_telefono" placeholder="Introduzca el número de teléfono">
